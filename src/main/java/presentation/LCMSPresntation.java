      ...
      //  Runtime.getRuntime().exec("cls");
       ...
       System.out.println("Genre name: ");
        ...
        else if(jdbcChoice==4)
        {
            ...
            System.out.println("Genre return using JDBC\n");
        ...
        public static void DoctypeJDBCMenu() throws IOException, SQLException
    {
      ...
      //  Runtime.getRuntime().exec("cls");
        ...
        else if(jdbcChoice==4)
        {
            ...
            System.out.println("doc type return using JDBC\n");
      ...
      //  Runtime.getRuntime().exec("cls");
        ...
        else if(ORMChoice==5)
        {
           ...
           // Runtime.getRuntime().exec("cls");
            ...
            System.out.println("ID: " +  documenttype.get(i).getId()+"\n");
 
            System.out.println(" Document type Name: " + documenttype.get(i).getName()+"\n");
      ...
      //  Runtime.getRuntime().exec("cls");
        ...
        else if(ORMChoice==4)
        {
           Catalogrecord anCatalogrecord=new Catalogrecord();
            ...
            System.out.println("catalog record return using ORM\n");
            System.out.println("ID: " + anCatalogrecord.getId()+"\n");
            System.out.println("Title: " + anCatalogrecord.getTitle()+"\n");
            System.out.println("Genre: " + anCatalogrecord.getGenre()+"\n");
            System.out.println("Document Type: " + anCatalogrecord.getDocumenttype()+"\n");
        ...
        {
          List<Catalogrecord> catalogrecord =new ArrayList();
            CatalogrecordManager Catalogrecordorm = new CatalogrecordManager();          
            Scanner aScanner = new Scanner(System.in);
           ...
           // Runtime.getRuntime().exec("cls");
            ...
            catalogrecord = Catalogrecordorm.getAllCatalogrecord();
            
           // Runtime.getRuntime().exec("cls");
            
            System.out.println("ResultSet of authors return using ORM\n");
            
            for(int i=0; i<catalogrecord.size(); i++){
            System.out.println("ID: " +  catalogrecord.get(i).getId()  +"\n");
            System.out.println("Title: " +  catalogrecord.get(i).getTitle()+"\n");
            System.out.println("Genre: " +  catalogrecord.get(i).getGenre()+"\n");
            System.out.println("Document Type:" +  catalogrecord.get(i).getDocumenttype()+"\n");
            System.out.println("released date: " +  catalogrecord.get(i).getDatereleased() +"\n");
            System.out.println("Author: " +  catalogrecord.get(i).getAuthor() +"\n");
           System.out.println("Publisher: " +  catalogrecord.get(i).getPublisher() +"\n");
            System.out.println("Catalog Code: " +  catalogrecord.get(i).getCatalogcode() +"\n");
            System.out.println("Condition Statement : " +  catalogrecord.get(i).getConditionstatement()+"\n");
        }
        }
        else if(ORMChoice==6)
        {
          ...
          public static void CatalogloanORMMenu() throws IOException, SQLException
    {
      ...
      //  Runtime.getRuntime().exec("cls");
        ...
        else if(ORMChoice==4)
        {
            ...
            System.out.println("loan return using ORM\n");
            System.out.println("ID: " + anCatalogloanrecord.getId()+"\n");
            System.out.println("Title: " + anCatalogloanrecord.getCatalogrecord()+"\n");
            System.out.println("Customer: " + anCatalogloanrecord.getCustomer()+"\n");
            System.out.println("Employee: " + anCatalogloanrecord.getEmployee()+"\n");
           ...
           public static void EmployeeORMMenu() throws IOException, SQLException
    {
      ...
      //  Runtime.getRuntime().exec("cls");
        ...
        else if(ORMChoice==4)
        {
            ...
            System.out.println("Employee return using ORM\n");
            System.out.println("ID: " + anEmployee.getId()+"\n");
            System.out.println("First Name: " + anEmployee.getFname()+"\n");
            System.out.println("Last Name: " + anEmployee.getLname()+"\n");
